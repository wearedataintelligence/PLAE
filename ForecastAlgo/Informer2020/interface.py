...
def get_data(data_sequence, flag, args):
...
def train_and_predict(data_sequence: np.array, window_len, pred_len):
    """
    ...
    #2. dataset
    train_data, train_loader = get_data(data_sequence, 'train', args)
#     vali_data, vali_loader = get_data(data_sequence, 'val', args)
#     test_data, test_loader = get_data(data_sequence, 'test', args)
    pred_data, pred_loader = get_data(data_sequence, 'pred', args)
...
if __name__ == '__main__':
    import pandas as pd
    data_sequence = np.array([6,5,4,3,2,1]*1000)
    train_and_predict(data_sequence,13,2)